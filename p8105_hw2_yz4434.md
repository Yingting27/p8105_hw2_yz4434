...
The average baseline age is **65.5419355**. The proportion of women in
...
There are **450** observations in the merged file, with important
...
There are **1985** observations in amyloid datasets, with **3**
observations in baseline datasets.
